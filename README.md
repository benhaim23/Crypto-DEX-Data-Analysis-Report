# Decentralized Exchange (DEX) Trading Analysis Across Multiple Chains
...
`DEX Data Analysis Report Across Chains.py` - Detailed analysis of DEX trading statistics with aggregated data of several blockchains with an interactive dashboard showcasing visualizations of dex statistics across chains.

`Decentralized Exchange (DEX) Trading Volumes and Liquidity by Chains.py` - Comparative analysis and an interactive dashboard for real-time data visualization by each chain respectively.
